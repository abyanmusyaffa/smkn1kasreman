    ...
    public function run(): void
    {
        ...
        DB::table('achievements')->insert([
            [
                ...
                'rankings' => 'Juara 3',
                'photo' => 'achievements/01JFMCBMF5JJ2749A7TPN1PCF6.jpg',
        ...
        DB::table('facilities')->insert([
            [
                'name' => 'Lab KKPI',
                'photo' => 'facility/01JFPCPPW678054TW5G7Z57ZQV.jpg',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                'name' => 'Lab Praktikum TKJ',
                'photo' => 'facility/01JFPCRP886HCCSFWVDAZNSTXF.jpg',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                'name' => 'Lab praktikum Akuntansi',
                'photo' => 'facility/01JFPCSPQ3CSEXKZR88E7Z0TK9.jpg',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                'name' => 'Lab Praktikum Kuliner',
                'photo' => 'facility/01JFPCTQFNJCRD8WW159GJHSWQ.jpg',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                'name' => 'Lab Praktikum Desain dan Produksi Busana',
                'photo' => 'facility/01JFPCWK9CSME0TN8739VZZF54.jpeg',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                'name' => 'Kantin',
                'photo' => 'facility/01JFPCXD52FSDCPGXHCKCWX7GK.jpg',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                'name' => 'Mushola',
                'photo' => 'facility/01JFPCXTGAMHZGKKQ6ZEN5RDDV.jpg',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                'name' => 'Bussiness Centre',
                'photo' => 'facility/01JFPCY9SYVM91SMTRQS4HRSJV.jpg',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                'name' => 'Ruang Kelas',
                'photo' => 'facility/01JFPCZ3QPMT48981T49X4HV36.jpg',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                'name' => 'Perpustakaan',
                'photo' => 'facility/01JFPCZP5B87XWPG5ATHDW85MF.jpg',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
        ]);
        ...
        DB::table('jobfairs')->insert([
            [
                ...
                'photo' => 'jobfair/01JG58DMZS82ZD18VBX9EKNJGQ.jpg',
                'deadline' => '2024-12-27',
            ...
            [
                ...
                'photo' => 'jobfair/01JG58G1EHE08SNDS3KWACD555.png',
                'deadline' => '2025-01-18',
            ...
            [
                ...
                'photo' => 'jobfair/01JG58J8DGSRKKHCWRVFVZZTPD.png',
                'deadline' => '2025-01-02',
            ...
            [
                ...
                'photo' => 'jobfair/01JG58MKVG7WNC7794ZYM9EZVZ.jpg',
                'deadline' => '2025-01-31',
            ...
            [
                ...
                'photo' => 'jobfair/01JG5WSCV1EWQZ218543ZV5B3N.jpg',
                'deadline' => '2025-02-15',
